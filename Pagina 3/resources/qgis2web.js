...
map.getView().fit([2438570.183511, 5953535.147783, 2442898.204142, 5955780.900039], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Implementare LTN-uri în cartierul Rogerius</h2>';
        return titleElement;
    })(),

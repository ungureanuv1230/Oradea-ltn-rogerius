...
map.getView().fit([2420570.281338, 5943644.301823, 2457881.901612, 5963598.229961], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Distribuția arborilor și parcurilor în Oradea</h2>';
        return titleElement;
    })(),

...
map.getView().fit([2437759.427337, 5953222.008323, 2443059.044436, 5955971.909044], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analiza densității arborilor în proximitatea stațiilor de transport public </h2>';
        return titleElement;
    })(),
